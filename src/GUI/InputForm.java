...
public class InputForm extends JFrame{
    ...
    public InputForm(Frame frame) {
		...
		JLabel lblNewLabel = new JLabel("Element Array (From 2 To 10)");
	...
	public void beAccepted() {
		...
		if (num != 0) {
			JOptionPane.showMessageDialog(this, "Array Data Created Successfully!\n Exit!");
			this.dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
		}
		else {
			JOptionPane.showMessageDialog(this, "Failed To Create Array Data!\n Exit!");
			this.dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
		}
